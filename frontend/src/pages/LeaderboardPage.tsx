...
import { Trophy, Star, Code2, Layers, Crown, RefreshCw } from 'lucide-react';
        ...
        action={
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-xs font-bold text-slate-700 hover:bg-slate-50 transition-all shadow-2xs cursor-pointer disabled:opacity-50"
              title="Manually recalculate leaderboard scores"
            >
